...
**Status (2026-07-20): PRs 1–4 done.** Not a UI-verification gap (none
of PRs 1–4 need one). PR 2 (teaching `Tracker` a fixed-root mode) turned
...
(`obs_blob` patching + `decode_obs_blob`/MCP companion update) is next.
